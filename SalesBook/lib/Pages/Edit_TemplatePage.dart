...
import 'package:flutter_application_1/Pages/PreviewEditTemplateScreen.dart';
...
class EditTemplatePage extends StatefulWidget {
  ...
  @override
  State<EditTemplatePage> createState() => _EditTemplateState();
}

class _EditTemplateState extends State<EditTemplatePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.template.label.toString()),
      ),
      body: Center(
        child:
